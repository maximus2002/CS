...
*/
	...
	private static final String FILE23= "\t\t\t\t\t"+
										"\t\t\t\t\t\n";
	...
	// Failure Type: BUG6 empty file error, index out of boundary
    @Test
	...
	// Failure Type: BUG4 -r misses the string 
    @Test
	...
	// Failure Type: BUG8 -l output file contain space, output format error
	@Test
	...
	// Failure Type: BUG5 repeated OPT flag
	@Test
	...
	// Failure Type: BUG4 OPT flag contain special characters
	@Test
	...
	// Failure Type: BUG10 empty OPT flag, index out of boundary
	@Test
    public void encodeTest34() throws Exception {
        File inputFile = createInputFile(FILE23);
	...
	// Failure Type: BUG3 -c contain empty string, index out of boundary
	@Test
	...
	// Failure Type: BUG3 -r -k contain empty string, index out of boundary
	@Test
	...
	// Failure Type: BUG9 -c argument contain both uppercase and lower case, can't reverse
	@Test
    public void encodeTest38() throws Exception {
        File inputFile = createInputFile(FILE9);

        String args[] = {"-c","cC",inputFile.getPath()};
        Main.main(args);
	...
	// Failure Type: BUG1 -a argument contains negative number
	@Test
    public void encodeTest39() throws Exception {
        ...
        String expected =  "aXYZ3456Axyz";

        String actual = getFileContent(inputFile.getPath());

        assertEquals("The files differ!", expected, actual);
	}
	// Failure Type: BUG7 -k or -r misses <string>, leave no character to keep or remove
	@Test
